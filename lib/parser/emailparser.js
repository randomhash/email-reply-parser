...
class EmailParser {
  constructor() {
    ...
    this.signatureRegex = [
      ...
      /^\s*(No(?:(?!^>*\s*No\b|\bescreveu:)[\s\S]){0,1000}escreveu:)$/m, // No dia DATE, NAME <EMAIL>escreveu: // we don't care if it will be cut/pushed into another sequences, we only need visible part
    ];
